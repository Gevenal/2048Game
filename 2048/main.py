...
twenty_forty_eight=1.TwentyFortyEight(rows,cols,const.OFFSETS)
board=b.Board(rows,cols,twenty_forty_eight.get_game_state(),const.PADDING,CONST.TILE_SIZE,
	const.BACKGROUND_COLOR,const.BACKGROUND_COLOR_EMPTY_TILE,const.BACKGOURND_TILE_COLORS,
...
while 1:
	...
	board.draw_board()
	board.draw_tiles()
	screen.bilt(board.get_board(),(0,0))
